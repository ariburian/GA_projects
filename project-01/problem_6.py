...
print "The data seems skewed to the right, as we saw previously, that the mean is larger than the median. There is also a second peek around 560, which implies that its not only outliers pulling up the mean."
...
print "The mean and median for math seem very similar to that of verbal, with a similar right skew.  For math, however, this is not second peak and the scores trail off gradually."
